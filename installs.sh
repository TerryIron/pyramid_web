...
source env/bin/activate && pip install greenlet 
cp -rf $PWD/env/include/site/python2.7/greenlet.h /usr/local/include 
mkdir /usr/local/include/greenlet
cp -rf $PWD/env/include/site/python2.7/greenlet.h /usr/local/include/greenlet
